...
function getInfoBasedOnScore(){
    ...
    if(totalScore() < 3){
        var score_info = "Você pode não ter nenhuma dessas!";
    }
    
    if(totalScore() > 3){
        var score_info = "Você pode estar com covid!";
    }
    
        if(totalScore()  >= 11) {
            var score_info = "Você pode estar com Gripe influenza!";
        }

        if(totalScore() >= 24) {
        var score_info = "Voçê pode estar com Fibrose Pulmonar!";
    }
